...
import NFTPageIsland from "../../islands/NFTPageIsland.tsx";
...
export const handler: Handlers<NFTPageData> = {
  async GET(_req, ctx) {
...
export default function NFTPage({ data }: PageProps<NFTPageData>) {
  return (
    <>
      <Head>
        <title>{data.project.displayName} - Ethos Signals</title>
        <meta name="description" content={`View all trading signals and performance for ${data.project.displayName} NFT`} />
      </Head>
              ...
              <div class="flex items-center gap-6">
                ...
                <div class="flex-1">
                  ...
                  <div class="flex items-center gap-4 text-gray-400">
                    ...
                    <span>•</span>
                    <span class="text-purple-400">NFT Collection</span>
                    {data.project.chain && (
                      <>
                        <span>•</span>
